...
public static class GizmosArrow
{
    ...
    /// </remarks>
    public static void Draw(Vector2 pos1, Vector2 pos2, Color color, float angleInDegrees = 20, float sizeMultiplier = 0.5f)
    {
        if (pos1 != pos2)
        {
            Gizmos.color = color;
            ...
            Gizmos.DrawRay(pos2, Quaternion.LookRotation(pos2 - pos1) * Quaternion.Euler(180 + angleInDegrees, 0, 0) * new Vector3(0, 0, 1) * sizeMultiplier);
            Gizmos.DrawRay(pos2, Quaternion.LookRotation(pos2 - pos1) * Quaternion.Euler(180 - angleInDegrees, 0, 0) * new Vector3(0, 0, 1) * sizeMultiplier);
        }
    }
}
